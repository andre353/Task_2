...
class TestCreateOrder:
    ...
    @allure.title("Неавторизованный пользователь: проверка статус-кода 200")
    ...
    def test_create_order_no_ingredients_body_fields(self, order_api, auth_user, json_key, expected_value):
        headers = {"Authorization": auth_user["token"]}
        payload = {"ingredients": []}
    ...
    def test_create_order_invalid_hash_status_code(self, order_api, auth_user):
        headers = {"Authorization": auth_user["token"]}
